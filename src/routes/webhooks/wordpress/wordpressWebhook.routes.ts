...
import { wordpressOrderStatus, wordpressVisitEvent, wordPressOrderWebhook } from "../../../controller/wordpress/wordpress-webhook.controller";

const router = Router();

router.post("/wordpress/webhook/utmapp/attributed-order", wordPressOrderWebhook);
